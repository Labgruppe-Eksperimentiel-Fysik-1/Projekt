...
\]
Vi ser at amplituderne falder med $\frac{2f_k}{k}$ hver gang den skifter retning, og at de dermed følger rekursionsligningen
\begin{equation}
    (-1)^{n+1} x_{n+1} = x_n - \frac{2f_k}{k}
\end{equation}
Rekursionsligningen er her skrevet på en meget akavet form, for at gøre det klart, at den absolutte amplitude falder med $\frac{2f_k}{k}$, for hver retninge skift, 
